        ...
        <div class="alert alert-danger" role="alert">
            ...
            <ul>
                <c:forEach var="error" items="${errors.allErrors}">
                    <li><spring:message message="${eroor}"/></li>
                </c:forEach>
            </ul>
        </div>
    </spring:hasBindErrors>

    <%--@elvariable id="horario" type=""--%>
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <form:select id="sala" path="sala" class="form-control">
                        <form:button value="Premium">Sala Premium</form:button>
                        <form:button value="Sala 1">Sala 1</form:button>
                        <form:button value="Sala 2">Sala 2</form:button>
                        <form:button value="Sala 3">Sala 3</form:button>
                    </form:select>
                </div>
            </div>
